...
namespace kissmath {
	...
	inline constexpr uint8& uint8v4::operator[] (int i) {
		return arr[i];
	}
	
	// Component indexing operator
	inline constexpr uint8 const& uint8v4::operator[] (int i) const {
		return arr[i];
	}
	...
	inline constexpr uint8v4::uint8v4 (uint8 all): x{all}, y{all}, z{all}, w{all} {
		
	}
	
	// supply all components
	inline constexpr uint8v4::uint8v4 (uint8 x, uint8 y, uint8 z, uint8 w): x{x}, y{y}, z{z}, w{w} {
		
	}
	
	// extend vector
	inline constexpr uint8v4::uint8v4 (uint8v2 xy, uint8 z, uint8 w): x{xy.x}, y{xy.y}, z{z}, w{w} {
		
	}
	
	// extend vector
	inline constexpr uint8v4::uint8v4 (uint8v3 xyz, uint8 w): x{xyz.x}, y{xyz.y}, z{xyz.z}, w{w} {
	...
	inline constexpr uint8v4::operator uint8v2 () const {
		return uint8v2(x, y);
	}
	
	// truncating cast operator
	inline constexpr uint8v4::operator uint8v3 () const {
	...
	// type cast operator
	inline constexpr uint8v4::operator bool4 () const {
		return bool4((bool)x, (bool)y, (bool)z, (bool)w);
	}
	
	// type cast operator
	inline constexpr uint8v4::operator float4 () const {
		return float4((float)x, (float)y, (float)z, (float)w);
	}
	
	// type cast operator
	inline constexpr uint8v4::operator int4 () const {
		return int4((int)x, (int)y, (int)z, (int)w);
	}
	
	// type cast operator
	inline constexpr uint8v4::operator int64v4 () const {
		return int64v4((int64)x, (int64)y, (int64)z, (int64)w);
	}
	
	
	// componentwise arithmetic operator
	inline uint8v4 uint8v4::operator+= (uint8v4 r) {
		x += r.x;
		y += r.y;
		z += r.z;
		w += r.w;
	...
	inline uint8 min_component (uint8v4 v, int* min_index) {
		int index = 0;
		uint8 min_val = v.x;	
		for (int i=1; i<4; ++i) {
			if (v.arr[i] <= min_val) {
	...
	inline uint8 max_component (uint8v4 v, int* max_index) {
		int index = 0;
		uint8 max_val = v.x;	
		for (int i=1; i<4; ++i) {
			if (v.arr[i] >= max_val) {
