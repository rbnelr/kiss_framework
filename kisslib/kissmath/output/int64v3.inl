...
namespace kissmath {
	...
	inline constexpr int64& int64v3::operator[] (int i) {
		return arr[i];
	}
	
	// Component indexing operator
	inline constexpr int64 const& int64v3::operator[] (int i) const {
		return arr[i];
	}
	...
	inline constexpr int64v3::int64v3 (int64 all): x{all}, y{all}, z{all} {
		
	}
	
	// supply all components
	inline constexpr int64v3::int64v3 (int64 x, int64 y, int64 z): x{x}, y{y}, z{z} {
		
	}
	
	// extend vector
	inline constexpr int64v3::int64v3 (int64v2 xy, int64 z): x{xy.x}, y{xy.y}, z{z} {
		
	}
	
	// truncate vector
	inline constexpr int64v3::int64v3 (int64v4 v): x{v.x}, y{v.y}, z{v.z} {
	...
	inline constexpr int64v3::operator int64v2 () const {
		return int64v2(x, y);
	}
	...
	// type cast operator
	inline constexpr int64v3::operator bool3 () const {
		return bool3((bool)x, (bool)y, (bool)z);
	}
	
	// type cast operator
	inline constexpr int64v3::operator float3 () const {
		return float3((float)x, (float)y, (float)z);
	}
	
	// type cast operator
	inline constexpr int64v3::operator int3 () const {
		return int3((int)x, (int)y, (int)z);
	}
	
	// type cast operator
	inline constexpr int64v3::operator uint8v3 () const {
		return uint8v3((uint8)x, (uint8)y, (uint8)z);
	}
	
	
	// componentwise arithmetic operator
	inline int64v3 int64v3::operator+= (int64v3 r) {
		x += r.x;
		y += r.y;
		z += r.z;
		return *this;
	...
	inline int64 min_component (int64v3 v, int* min_index) {
		int index = 0;
		int64 min_val = v.x;	
		for (int i=1; i<3; ++i) {
			if (v.arr[i] <= min_val) {
	...
	inline int64 max_component (int64v3 v, int* max_index) {
		int index = 0;
		int64 max_val = v.x;	
		for (int i=1; i<3; ++i) {
			if (v.arr[i] >= max_val) {
