...
namespace kissmath {
	...
	inline constexpr uint8& uint8v2::operator[] (int i) {
		return arr[i];
	}
	
	// Component indexing operator
	inline constexpr uint8 const& uint8v2::operator[] (int i) const {
		return arr[i];
	}
	...
	inline constexpr uint8v2::uint8v2 (uint8 all): x{all}, y{all} {
		
	}
	
	// supply all components
	inline constexpr uint8v2::uint8v2 (uint8 x, uint8 y): x{x}, y{y} {
		
	}
	
	// truncate vector
	inline constexpr uint8v2::uint8v2 (uint8v3 v): x{v.x}, y{v.y} {
		
	}
	
	// truncate vector
	inline constexpr uint8v2::uint8v2 (uint8v4 v): x{v.x}, y{v.y} {
	...
	// type cast operator
	inline constexpr uint8v2::operator bool2 () const {
		return bool2((bool)x, (bool)y);
	}
	
	// type cast operator
	inline constexpr uint8v2::operator float2 () const {
		return float2((float)x, (float)y);
	}
	
	// type cast operator
	inline constexpr uint8v2::operator int2 () const {
		return int2((int)x, (int)y);
	}
	
	// type cast operator
	inline constexpr uint8v2::operator int64v2 () const {
		return int64v2((int64)x, (int64)y);
	}
	
	
	// componentwise arithmetic operator
	inline uint8v2 uint8v2::operator+= (uint8v2 r) {
		x += r.x;
		y += r.y;
		return *this;
	}
	...
	inline uint8 min_component (uint8v2 v, int* min_index) {
		int index = 0;
		uint8 min_val = v.x;	
		for (int i=1; i<2; ++i) {
			if (v.arr[i] <= min_val) {
	...
	inline uint8 max_component (uint8v2 v, int* max_index) {
		int index = 0;
		uint8 max_val = v.x;	
		for (int i=1; i<2; ++i) {
			if (v.arr[i] >= max_val) {
