...
namespace kissmath {
	...
	struct int2 {
		...
		inline constexpr int2 (int all);
		
		// supply all components
		inline constexpr int2 (int x, int y);
		
		// truncate vector
		inline constexpr int2 (int3 v);
		
		// truncate vector
		inline constexpr int2 (int4 v);
	...
	inline int min_component (int2 v, int* min_index=nullptr);
	
	// get maximum component of vector, optionally get component index via max_index
	inline int max_component (int2 v, int* max_index=nullptr);
