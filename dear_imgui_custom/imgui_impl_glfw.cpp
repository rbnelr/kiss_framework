...
void ImGui_ImplGlfw_NewFrame(bool interaction_enabled)
{
	...
	// Imgui does not seem to support just making the UI invsible instantly
	// (I can simply disable the drawing of imgui, but it will still respond to clicks, be stuck in a mouse-capturing event, etc.)
	// so I hack in that functionality here with interaction_enabled as the API to control when to cancel all interaction (when interaction_enabled = false)
